...
Visualization-language reference for agent-generated charts and structured visual output.
...
Native AI / agent-output visualization reference.

## Optional Use by TopPrism

Reference for TopPrism's Native AI agents when producing human-editable chart specs.

## Sync / Maintenance Status

Snapshot retained for evaluation; not actively synced with upstream. Future re-sync requires manual review of upstream breaking changes before mirroring.
